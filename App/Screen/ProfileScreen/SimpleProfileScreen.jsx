    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={{flexDirection: 'row', marginTop: 15}}>
          ...
          <View style={{marginLeft: 20}}>
            <Title style={[styles.title, {
              marginTop:15,
              marginBottom: 5,
            }]}>Charging Blazer</Title>
            <Caption style={styles.caption}>@red_Blazer</Caption>
          </View>
        </View>
      </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color:"#777777", marginLeft: 20}}>Bacau, Romania</Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#777777" size={20}/>
          <Text style={{color:"#777777", marginLeft: 20}}>+40712345678</Text>
        </View>
        <View style={styles.row}>
      ...
      <View style={styles.menuWrapper}>
        ...
        <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
            <Icon name="settings-outline" color={Colors.PRIMARY} size={25}/>
